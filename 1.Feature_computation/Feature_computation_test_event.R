...
data_test_feature_event=list()
for (i in 1:500){
  data_test<-data_sim_test[[i]]
  data_test<-subset(data_test,CVD_DTH_UNADJ_sim==1)
...
data_test_feature_event[[i]]<-cbind(data_pst,V1=V1,V2=V2,V3=V3)
}
save(data_test_feature_event,file="data_test_feature_event.RData")
